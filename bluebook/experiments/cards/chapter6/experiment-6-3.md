# 实验 6-3：三层用户记忆评估集；实验 6-3 的四档多维 Rubric、逐维证据与幻觉一票否决
...
三层用户记忆评估集；实验 6-3 的四档多维 Rubric、逐维证据与幻觉一票否决
...
chapter3/README.md:26、chapter6/README.md:22

## 代码与Artifact

- `chapter3/user-memory-evaluation`
- `chapter6/astra-async-steering`
