# 实验 6-10：真机遥操作 XLeRobot 整理桌面：把红色杯子放进托盘、把黄色废纸放进垃圾盒，最后重新观察并确认状态
...
真机遥操作 XLeRobot 整理桌面：把红色杯子放进托盘、把黄色废纸放进垃圾盒，最后重新观察并确认状态
...
chapter6/README.md:30

## 代码与Artifact

- `chapter6/xlerobot-teleoperation`
