# 实验 8-15：bojieli/AWorld 中的 GAIA MCP 沙盒与训练入口，bojieli/verl 为训练后端
...
bojieli/AWorld 中的 GAIA MCP 沙盒与训练入口，bojieli/verl 为训练后端
...
chapter8/README.md:36

## 代码与Artifact

- `chapter8/AWorld-train`
